...
describe 'trove::keystone::authtoken' do
  ...
  shared_examples 'trove::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('trove_config').with(
          :username                       => 'trove',
          :password                       => 'trove_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'trove::keystone::authtoken'
    end
  end
